...
void fit2()
{
  ...
  TFile * data = new TFile("~/unpacker/sort9Be.root");
  ...
  Double_t fparam2[5] = {0.028,0.051,0.122,0.312,10.};
  ...
  projection->SetMarkerStyle(8);
  projection->Draw("sameP");
  f->GetYaxis()->SetRangeUser(0,16500); //for 12C
  ...
  //latex3.DrawLatex(-0.2,12500,"#color[4]{3}"); //11500 for 12C, 12500 for 9Be
  TLatex pugthis;
